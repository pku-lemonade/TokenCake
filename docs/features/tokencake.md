...
commitments. By default, `scheduling.reserve_generation_tokens` is enabled and
`scheduling.generation_reserve_mode="all"` commits every admitted request's
remaining declared generation budget.
