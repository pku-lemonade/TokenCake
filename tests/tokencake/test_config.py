...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"scheduling": {"generation_reserve_mode": "unknown"}},
        ...
        {"scheduling": {"inherit_join_priority": 1}},
        {"scheduling": {"priority_borrow_score_margin": -1}},
        {"scheduling": {"priority_borrow_score_margin": True}},
        ...
        {"offload": {"max_relief_blocks": -1}},
        {"offload": {"max_relief_blocks": True}},
